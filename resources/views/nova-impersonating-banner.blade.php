<div>
    @if ($isImpersonating)
        <div class="items-center justify-center w-full p-2 text-center text-white bg-red-600 md:flex">
            ...
            <button wire:click="stopImpersonating" class="inline-flex items-center px-4 py-2 ml-auto text-xs font-semibold tracking-widest text-white uppercase transition bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-hidden focus:border-gray-900 focus:ring-3 focus:ring-gray-300 disabled:opacity-25">Stop Impersonating</button>
        </div>
    @endif
</div>
